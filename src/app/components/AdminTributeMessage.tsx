    ...
    <div className="relative">
      ...
      >
        ...
        {!isExpanded && shouldShowReadMore && (
          <div className="absolute bottom-0 left-0 right-0 h-6 bg-gradient-to-t from-slate-50 via-slate-50/90 to-transparent pointer-events-none" />
        )}
      </div>
      ...
      {shouldShowReadMore && (
        <button
          ...
          className="mt-3 text-blue-600 hover:text-blue-700 transition-colors duration-200 text-sm font-medium flex items-center space-x-1 group"
        >

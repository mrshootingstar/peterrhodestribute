      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-6 lg:py-8">
        ...
        <section className="text-center mb-6 sm:mb-14 lg:mb-16">
          <div className="max-w-4xl mx-auto bg-gray-800 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-12 border border-gray-700">
            ...
            <div className="text-2xl sm:text-2xl md:text-3xl text-gray-300 mb-4 sm:mb-6 lg:mb-8 font-semibold">
              1948 - 2025
            </div>
            <p className="text-xl sm:text-xl md:text-2xl text-gray-200 leading-relaxed italic px-2 sm:px-4">
        ...
        <section className="mb-8 sm:mb-12 lg:mb-16">
          <div className="max-w-6xl mx-auto">
            <h3 className="text-3xl sm:text-3xl md:text-4xl font-bold text-center text-white mb-8 sm:mb-10 lg:mb-12 px-4">
              Tributes & Memories
            </h3>
            <TributesList />
          </div>
        ...
        <footer className="text-center mt-12 sm:mt-16 lg:mt-20 py-6 sm:py-8 border-t border-gray-700">
          <h4 className="text-2xl sm:text-2xl font-bold text-white mb-2">
